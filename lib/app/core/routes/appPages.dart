...
import '../../features/search/presentation/binding/searchBinding.dart';
import '../../features/search/presentation/pages/searchScreen.dart';
...
class AppPages {
  static final List<GetPage> pages = [
    ...
    GetPage(name: AppPageName.search, page: () => const SearchScreen(), binding: SearchBinding()),
